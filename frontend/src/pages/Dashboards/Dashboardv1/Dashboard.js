import React, { Component, lazy, Suspense, Icon } from 'react';
...
const Widget03 = lazy(() => import('../../../views/Widgets'));
                      ...
                      <Card>
                        <CardHeader>
                          ...
                          <div className="card-header-actions">
                            <Link className="card-header-action">
                              <Icon name="cil-settings" />
                            </Link>
                            <Link className="card-header-action" onClick={() => setCollapsed(!collapsed)}>
                              <Icon name={collapsed ? 'cil-chevron-bottom':'cil-chevron-top'} />
                            </Link>
                            <Link className="card-header-action" onClick={() => setShowCard(false)}>
