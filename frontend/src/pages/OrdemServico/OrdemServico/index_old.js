...
const OrdemServico = (props) => {
    ...
    //combos dinamicos
    const [clienteFinais, setClienteFinais] = useState([]);
    ...
    useEffect(() => {
        api.get('cliente-final').then(response => {
            setClienteFinais(response.data);
        })
    }, [usuarioId]);
                                ...
                                >
                                    ...
                                    >
                                        <FormGroup row>
                                            ...
                                            <Col md="4">
                                                <Label htmlFor="clienteFinalId">Final do Cliente</Label>
                                                <InputGroup>
                                                    <Input required type="select" id="cboClienteFinal"
                                                        value={clientefinalid}
                                                        name="clientefinalid"
                                                        onChange={handleInputChange}
                                                    >
                                                        <option value={undefined} defaultValue>Selecione...</option>
                                                        {clienteFinais.map(clienteFinal => (
                                                            <option key={clienteFinal.id} value={clienteFinal.id}>{clienteFinal.nomefinal}</option>
                                                        ))}
                                                    </Input>
                                                    <InputGroupAddon addonType="append">
