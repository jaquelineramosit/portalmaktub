...
export default function ListaStatusPagamento() {
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            right: true,
            cell: row => <Link to={`status-pagamento/${row.id}?action=edit`} className="btn-sm btn-primary"><i className="fa fa-pencil fa-lg mr-1"></i></Link>
        },
    ];
    return (
            ...
            <Row>
                <Col xs="12" lg="12">
                    <Card>
                        ...
                        <Link to={`status-pagamento?action=novo`} className="btn btn-secondary float-right">
